/**
 * Copied from web-buyer-portal/components/EmptyState.tsx verbatim — same
 * "copied, not shared via a package" convention this repo already uses for
 * cross-app/cross-service platform code (two consumers don't earn a
 * shared package yet). See MASTER.md's "Empty / Not-Found State" spec.
 */
